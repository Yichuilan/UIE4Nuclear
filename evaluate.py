...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default='./UIE-clean', help="The path of saved model that you want to load.")
    parser.add_argument("--test_path", type=str, default="./re_data/dev.txt", help="The path of test set.")
